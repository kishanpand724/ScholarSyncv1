...
export const CombinationCard: React.FC<CombinationCardProps> = ({
  ...
  return (
    <div
      className={`bg-white rounded-2xl border transition-all duration-200 flex flex-col justify-between overflow-hidden shadow-xs hover:shadow-sm ${
        isFeatured
    ...
    >
      <div className="p-6">
        ...
        <div className="flex items-center justify-between gap-2 mb-4">
          ...
          <span className="inline-flex items-center gap-1 font-mono text-[10px] uppercase font-bold px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-800 border border-emerald-200">
            ...
            <React.Fragment key={s.id}>
              {idx > 0 && (
                <div className="flex items-center justify-center py-0.5">
                  <span className="w-5 h-5 rounded-full bg-gray-100 text-gray-600 text-[10px] font-bold font-mono flex items-center justify-center">
                    +
                  </span>
                </div>
              )}
              <div className="p-3 rounded-xl bg-gray-50/80 border border-gray-100 hover:border-gray-200 transition-colors flex items-center justify-between gap-2">
                <div className="min-w-0">
                  <div className="flex items-center gap-1.5 mb-0.5">
                    <span className="font-mono text-[9px] font-bold uppercase px-1.5 py-0.2 rounded bg-white text-gray-600 border border-gray-200">
                      {s.source_type || 'NSP'}
                    </span>
        ...
        <div className="flex items-center gap-2">
          {onInspectNetwork && (
            <button
              ...
              className="inline-flex items-center gap-1 text-[11px] font-semibold text-gray-600 hover:text-gray-900 transition-colors cursor-pointer"
